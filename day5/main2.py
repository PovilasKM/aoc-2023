...
for seed_interval in seed_intervals:
    ...
    while i < len(lines):
        ...
        print('applying: ' + lines[i] + ': ', f'destination: ({destination_start}, {destination_end}), source: ({source_start}, {source_end})')
    ...
    print('@@', intervals, min([x[0] for x in intervals]))
